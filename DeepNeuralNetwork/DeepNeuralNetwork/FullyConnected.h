...
public:
	...
	void update(Optimizer& opt) {
		ConstAllignedMapVec dw(m_dw.data(), m_dw.size());
		ConstAllignedMapVec db(m_db.data(), m_db.size());
		AllignedMapVec w(m_weight.data(), m_weight.size());
		AllignedMapVec b(m_bias.data(), m_bias.size());
