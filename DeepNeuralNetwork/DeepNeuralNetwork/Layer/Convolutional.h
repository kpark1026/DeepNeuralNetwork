...
private:
	...
	typedef Matrix::ConstAlignedMapType ConstAlignedMat;
	typedef Vector::ConstAlignedMapType ConstalignedVec;
...
public:
	...
	void update(Optimizer& opt){
		ConstalignedVec dw(m_df_data.data(), m_df_data.size());
		ConstalignedVec db(m_db.data(), m_db.size());
